...
const menuItems = [
  ...
  { name: 'navigation.codex', path: '/codex' },
  { name: 'navigation.skills', path: '/habilidades' },
  { name: 'navigation.traits', path: '/rasgos' },
];
</script>
  ...
  <div>
    ...
    >
      <div class="flex items-center justify-between mt-8 px-6">
        <span class="text-gray-800 dark:text-white text-2xl font-semibold">OCW Codex</span>
